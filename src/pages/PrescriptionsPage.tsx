...
const PrescriptionsPage = () => {
  ...
  const handleOrderMedicine = (_prescription: any) => {
    toast.success('Medicine order placed successfully!');
    // In a real app, this would navigate to the delivery page
  };
                  ...
                  <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                    ...
                    {!isDoctor && prescription.status === 'active' && (
                      <button
                        ...
                        className="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg"
                      >
